...
with mid:
    ...
    with col1:
        st.image("lora/before_refiner.png", caption="Image generated by Orange")
    with col2:
        st.image("lora/after_refiner.png", caption="After using realisticVisionV60B1_v51HyperVAE refiner")
    ...
    with col_a:
        st.image("lora/young.png", caption="weight -2")
    with col_b:
        st.image("lora/after_refiner.png", caption="weight 0")
    with col_c:
        st.image("lora/old.png", caption="weight 2")
    ...
    with col_d:
        st.image("lora/many_people.png", caption="weight -2")
    with col_e:
        st.image("lora/runner.png", caption="weight 0")
    with col_f:
        st.image("lora/no_people.png", caption="weight 2")
    ...
    with col6:
        st.image("lora/malaysian.png", caption="__ethnicity__ = 'Malaysian'")
    with col7:
        st.image("lora/nigerian.png", caption="__ethnicity__ = 'Nigerian'")
    with col8:
        st.image("lora/irish.png", caption="__ethnicity__ = 'Irish'")
